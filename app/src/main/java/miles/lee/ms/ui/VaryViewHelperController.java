...
public class VaryViewHelperController {
    ...
    public void showNetworkErrorView(View.OnClickListener onClickListener) {
        View layout = helper.inflate(R.layout.message_view);
    ...
    public void showErrorView(String errorMsg,int img, View.OnClickListener onClickListener) {
        View layout = helper.inflate(R.layout.message_view);
        TextView textView = (TextView) layout.findViewById(R.id.message_info);
        if (errorMsg != null) {
            textView.setText(errorMsg);
    ...
    public void showLoadingView(String msg) {
        View layout = helper.inflate(R.layout.loading_view);
        if (!TextUtils.isEmpty(msg)) {
            TextView textView = (TextView) layout.findViewById(R.id.loading_msg);
            textView.setText(msg);
        }
        ProgressBar loadingStateProgressBar = (ProgressBar) layout.findViewById(R.id.loading_progress);
